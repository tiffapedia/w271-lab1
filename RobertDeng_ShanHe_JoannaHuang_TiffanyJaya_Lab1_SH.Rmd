...
replicate(1000, bootstrap_coef(challenger$Temp, challenger.glm.temp, 31), simplify = FALSE)

replicate(1000, bootstrap_coef(challenger$Temp, challenger.glm.temp, 72), simplify = FALSE)
```
