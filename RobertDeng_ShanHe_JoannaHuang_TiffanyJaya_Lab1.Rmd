...
From the statistical output displayed above, it appears that Temp is a better explanatory variable for the dependent variable than Pressure. We confirm our intuition by performing a likelihood ratio test of the base case (bm1) against models that separate out Temp (bm2) and Pressure (bm3, bm4).
