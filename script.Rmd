...
```{r}
get.pi.hat.star <- function(given.temps, given.model, given.formula, sample.size, total.O.rings, which.temp){
...
get.ci.w.parametric.bootstrap <- function(given.temps, given.model, given.formula, sample.size, total.O.rings, which.temp, num.datasets, percent.ci) {
  mult.pi.hat.star <- replicate(num.datasets, get.pi.hat.star(given.temps, given.model, given.formula, sample.size, total.O.rings, which.temp))
  return(quantile(mult.pi.hat.star, c(1-percent.ci, percent.ci)))
}
